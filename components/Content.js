...
<section>
  ...
  <p>
    ...
    so...My name is Rusty Hoppins and I am <em>very</em> excited to
    ...
    camper.<img
      ...
      width="200"
    /><br /><br />That's one of the reasons Web Development appeals to me
    ...
    contribution to it. So get ready, Universe, because
...
<div class="med-column">
  <section>
    ...
    <p>
      ...
      voluptatibus est officiis at quis perspiciatis eligendi fugit,
      aperiam ratione, debitis nam. Libero?
    </p>

    <p>
      Lorem ipsum dolor, sit amet consectetur adipisicing elit. Error
      fugiat culpa quod vero laborum cupiditate, repellendus dolorum
      veniam neque vitae eveniet, dicta placeat saepe eaque dolore
      nesciunt maiores? Numquam, illum.
    </p>

    <p>
      Lorem ipsum dolor sit amet consectetur adipisicing elit. Id
      reprehenderit earum ex suscipit explicabo ea, provident, ratione
      nulla iure repellendus expedita recusandae labore nisi. Dignissimos
      possimus porro exercitationem quas modi.
    </p>

    <p>
      Nobis nam repellat ipsam deleniti incidunt dolores ipsa odit aliquam
      voluptatem excepturi! Esse recusandae ullam accusantium eos deserunt
      officiis quibusdam animi quisquam nulla. Delectus sapiente
      necessitatibus minus excepturi voluptas et.
    </p>
  </section>
  ...
  <section>
    ...
    <p>
      ...
      repudiandae accusantium nostrum non autem earum? Porro unde ducimus
      eaque placeat magnam suscipit voluptatum reiciendis ea tempore
      labore, ipsum esse rerum!
    </p>

    <p>
      Voluptas est aut aspernatur architecto libero eligendi nobis aliquid
      ullam expedita inventore mollitia minima saepe voluptatum placeat
      qui nam, consequatur perferendis quasi vel officiis labore doloribus
      numquam ut vitae! Error?
    </p>

    <p>
      Alias distinctio nihil eum quod culpa ad doloremque hic doloribus,
      aperiam reiciendis corporis ducimus perferendis sint architecto
      quisquam accusantium minima enim saepe veritatis molestias omnis
      voluptas expedita consectetur. Neque, perspiciatis?
    </p>
  </section>
</div>
</main>`;
